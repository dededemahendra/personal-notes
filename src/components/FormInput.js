...
function FormInput({ onSubmit, onTitleChange, onBodyChange, title, body, limit }) {
  return (
    <form onSubmit={onSubmit} className="form_input">
      ...
      <div className="input">
        ...
        <textarea name="note_value" className="note_value" cols="30" rows="10" value={body} onChange={onBodyChange} required></textarea>
      </div>
